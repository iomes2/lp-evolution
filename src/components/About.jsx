    ...
    <section className="bg-[#1C1C1C] text-white py-20 md:py-24">
      <div className="container-default">
        ...
        >
          ...
          {/* 1 — 15+ | col-span-4 */}
          <StaggerItem className="col-span-2 md:col-span-4 bg-[#161616] border border-white/[0.06] p-6 flex flex-col items-center justify-center gap-3 rounded-sm hover:border-primary/20 transition-all duration-300 text-center">
          ...
          {/* 4 — Projetos Personalizados | col-span-2 */}
          <StaggerItem className="col-span-2 md:col-span-2 bg-[#161616] border border-white/[0.06] p-6 lg:p-8 flex flex-col justify-center gap-3 rounded-sm hover:border-primary/20 transition-all duration-300">
            <div className="w-8 h-8 rounded-full border border-primary/30 flex items-center justify-center mb-2">
              <span className="text-primary font-black text-xs">1</span>
            </div>
            <h3 className="font-display font-black text-sm uppercase tracking-wider text-white mb-1">Projetos Personalizados</h3>
            <p className="text-xs text-gray-400 leading-relaxed">
              Do planejamento à entrega final — desenvolvemos projetos sob medida para o perfil real de uso do seu espaço.
            </p>
          </StaggerItem>

          {/* 5 — Entrega para todo o Brasil | col-span-2 */}
          <StaggerItem className="col-span-2 md:col-span-2 bg-[#161616] border border-white/[0.06] p-6 lg:p-8 flex flex-col justify-center gap-3 rounded-sm hover:border-primary/20 transition-all duration-300">
            <div className="w-8 h-8 rounded-full border border-primary/30 flex items-center justify-center mb-2">
              <span className="text-primary font-black text-xs">2</span>
            </div>
            <h3 className="font-display font-black text-sm uppercase tracking-wider text-white mb-1">Entrega para todo o Brasil</h3>
            <p className="text-xs text-gray-400 leading-relaxed">
              Entregamos e montamos com equipe especializada em todo o Brasil, com foco em performance, durabilidade e sofisticação.
            </p>
          </StaggerItem>

          {/* 6 — Quem Atendemos | col-span-4 */}
          <StaggerItem className="col-span-2 md:col-span-4 bg-[#161616] border border-white/[0.06] p-6 rounded-sm hover:border-primary/20 transition-all duration-300">
          ...
          {/* 7 — CTA bottom | col-span-4 */}
          <StaggerItem className="col-span-2 md:col-span-4 bg-[#111111] border border-white/[0.06] p-7 rounded-sm flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
